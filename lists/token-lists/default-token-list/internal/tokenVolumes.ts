...
export const BLOCKS: Partial<Record<ChainId, string>> = {
  [ChainId.MATIC]: "kamiswap-lab/blocks-polygon",
  [ChainId.FANTOM]: "kamiswap-lab/blocks-ftm",
  [ChainId.BSC]: "kamiswap-lab/blocks-bsc",
  [ChainId.AVALANCHE]: "kamiswap-lab/blocks-avax",
...
export const EXCHANGE: Partial<Record<ChainId, string>> = {
  [ChainId.AVALANCHE]: "kamiswap-lab/exchange-avax",
  [ChainId.FANTOM]: "kamiswap-lab/exchange-ftm",
  [ChainId.MATIC]: "kamiswap-lab/exchange-polygon",
  [ChainId.BSC]: "kamiswap-lab/exchange-bsc",

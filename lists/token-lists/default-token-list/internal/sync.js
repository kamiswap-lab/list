...
(async () => {
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      // Grab file file names of the kamiswap/icons repo at the token path
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("kamiswap/icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/kamiswap-lab/list/master/logos/token-logos/token/${icon}.jpg`;
